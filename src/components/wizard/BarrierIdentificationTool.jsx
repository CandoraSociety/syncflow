...
export default function BarrierIdentificationTool({ client, onSave, onComplete }) {
  ...
  const handleToggle = (val) => {
    if (!val && hasBarrierData && barriersIdentified) {
  ...
  const confirmNo = () => {
    setBarriersIdentified(false);
    setBarriers([emptyBarrier()]);
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl p-6 max-w-md mx-4">
            ...
            <p className="text-sm text-slate-600 mb-4">
              Selecting "No" will clear all barrier information that has been entered. This action cannot be undone. Please make sure all fields are saved before proceeding.
            </p>
