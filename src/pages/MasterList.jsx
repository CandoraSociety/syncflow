...
export default function MasterList() {
  ...
  useEffect(() => {
    base44.entities.Client.list("-intake_date").then(data => {
      setClients(data);
      setLoading(false);
    });
  }, []);
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="px-6 py-4">
        <div className="relative max-w-md mb-4">
          ...
          <Input
            className="pl-9"
            placeholder="Search by name, HSID#, phone, email, worker..."
            value={search}
            ...
            <table className="w-full text-sm">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="text-left px-3 py-3 font-semibold text-slate-600 whitespace-nowrap">Worker</th>
              ...
              <tbody className="divide-y divide-slate-100">
                ...
                {filtered.length === 0 && (
                  <tr><td colSpan={14} className="text-center py-10 text-slate-400">No clients found.</td></tr>
                )}
              </tbody>
            </table>
          </div>
